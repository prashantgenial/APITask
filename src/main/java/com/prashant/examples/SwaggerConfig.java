...
public class SwaggerConfig {
	...
	public Docket postsApi() {
		/*return new Docket(DocumentationType.SWAGGER_2).groupName("public-api")
				...
				*/
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.prashant.examples.controller"))
				.paths(regex("/media.*")).build();
	}
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Prashant API")
				...
				.termsOfServiceUrl("https://babbiunplugged.blogspot.com")
